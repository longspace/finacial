        ...
        return {
          ...
          tablecfg: {
              headerOptions:[
                  ...
                  { title: '用户角色', field: 'roleAuth',width:'230px'},
          ...
          dialogformcfg:{
            ...
            data:[
              {type:'Input',label:'用户账号',field:'account',icon:'user'},
              ...
              {type:'Select',label:'所属部门',field:'department',icon:'control',mode:"multiple",options:[{id:100,label:'财务部'},{id:101,label:'市场部'},{id:103,label:'法务部'},]},
